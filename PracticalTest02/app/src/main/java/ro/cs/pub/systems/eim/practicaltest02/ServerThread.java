...
public class ServerThread extends Thread{
    ...
    public ServerThread(int port) {
        ...
        this.data = new HashMap<String, PokemonInformation>();
    }
    ...
    public synchronized void setData(String pokename, PokemonInformation pokemonInformation) {
        this.data.put(pokename, pokemonInformation);
    }
