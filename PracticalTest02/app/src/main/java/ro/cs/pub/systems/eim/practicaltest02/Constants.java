...
public interface Constants {
    ...
    final public static String WEB_SERVICE_ADDRESS = "https://pokeapi.co/api/v2";
    final public static String WEB_SERVICE_MODE = "json";

    final public static String ABILITIES = "abilities";
    final public static String TYPES = "types";
